...
# Block File Explorer + the Settings app for the user. (explorer.exe is re-blocked: the print-broker
# approach that needed it runnable is reverted for now - it spawned a Windows taskbar/desktop.)
...
# and $script:HideExplorerWindows are left defined but intentionally NOT invoked.
